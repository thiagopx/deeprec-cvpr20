...
ax1.set_xticks(x1)
ax1.set_xticklabels(('Proposed', 'Paix\~ao-b'))
...
ax2.legend((p4[0], p5[0]), ('Proposed', 'Paix\~ao-b'), title='\\textbf{method}', fontsize=16, title_fontsize=16)

idx = np.where(x2 == 30)[0][0]
t_prop = total_prop[idx]
t_sib18 = total_sib18[idx]

ax2.annotate('$\\approx$1 page', xy=(30, 10), xytext=(40, 1200),
